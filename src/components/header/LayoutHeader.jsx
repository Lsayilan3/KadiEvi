            ...
            <div className="col-lg-12">
              <div className="top-bar-items">
                ...
                <div className="top-bar-icon">
                  <Link href="/">
                    <a>
                      {/* <img style={{width:250,height:54}}  src="assets/images/header-logo2d.svg" alt="" /> */}
                    </a>
                  </Link>
                </div>
                <div className="email d-flex align-items-center">
                  ...
                  <div className="email-info">
                    <span>
                    <FormattedMessage id="emailH" values={{ name }} />
                    </span>
                    <h6>
                ...
                <ul className="menu-list">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <FormattedMessage id="house_2plus1" values={{ name }}/></a>
                        </Link>
                      </li>
                {/* <li>
                    ...
                    >
                      <li>
                        <Link href="/hotel-facilities">
                          ...
                          >
                             <FormattedMessage id="tesislerimiz" values={{ name }} />
                          </a>
                        </Link>
                      </li>
                      <li>
                        <Link href="/faq">
                          <a
                            className={
                              currentRoute === "/faq" ? "active" : "disabled"
                            }
                          >
                           <FormattedMessage id="sss" values={{ name }} />
                          </a>
                        </Link>
                      </li>
                    </ul>
                ...
                <div className="header-btn">
                  <Link href="/room-suits1">
                    <a className="btn--primary eg-btn"> 
                     <FormattedMessage id="rezervasyon"   values={{ name }}/>
                    </a>
                  </Link>
                </div>
                <div
