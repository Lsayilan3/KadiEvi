...
function Header1({ name }) {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      // Tarayıcı ortamında olup olmadığını kontrol edin
              ...
              <div className="top-bar-items">
                {currentRoute === "/" ? (
                  <div className="email d-flex align-items-center">
                    ...
                    />
                      ...
                      <h6>
                        <a href="mailto:info@kadievi.com">info@kadievi.com</a>
                      </h6>
                    </div>
                  </div>
                ) : currentRoute === "/index2" ? (
                  <div className="hotline">
                    ...
                    <div className="hotline-info">
                      ...
                      <h6>
                        <a href="tel:+903843418866">+90 384 341 88 66</a>
                      </h6>
                    </div>
                  </div>
                ) : (
                ...
                {currentRoute === "/index2" ? (
                  <div className="top-bar-icon">
                    <Link href="/">
                      <a>
                        {/* <img src="assets/images/header-logo2d.svg" alt="" /> */}
                      </a>
                    </Link>
                  </div>
                ) : (
                ...
                {currentRoute === "/" ? (
                  <div className="social-icon">
                    <ul className="d-flex align-items-center">
                      ...
                      <li>
                        <a target="_blank" rel="noreferrer"  href="https://www.instagram.com/cappadocia_kadievi/">
      ...
      >
        ...
        >
          <div className="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
            <div className="mobile-logo-wrap ">
              <Link href="/">
                <a>
                  {/* <img alt="image" src="assets/images/header-logo2d.svg" /> */}
                </a>
              </Link>
            </div>
          ...
          <ul className="menu-list">
            <li onClick={() => dispatch({ type: "homeOne" })}>
              <Link className="link-style" href="/">
                <a className="link-style">
                  <FormattedMessage id="anasayfa" values={{ name }} />
                </a>
              </Link>
            </li>
            ...
            <li>
              <Link href="/about">
                <a className="link-style">
                  <FormattedMessage id="hakkimizda" values={{ name }} />
                </a>
              </Link>
            </li>
            <li
            ...
            >
              ...
              >
                <FormattedMessage id="evler" values={{ name }} />
              </a>
              <i
                className={
                  state.activeMenu === "suits"
              ...
              >
                <li>
                  <Link href="/room-suits1">
                    <a><FormattedMessage id="house_2plus1" values={{ name }}/></a>
                  </Link>
                </li>
                {/* <li>
                  <Link href="/room-suits2">
                    <a><FormattedMessage id="house_1plus1" values={{ name }}/></a>
                  </Link>
                </li> */}
                <li>
                  <Link href="/room-suits4">
                  <a><FormattedMessage id="suites" values={{ name }}/></a>
                  </Link>
                </li>
                <li>
                  <Link href="/room-suits3">
                  <a><FormattedMessage id="luxury" values={{ name }}/></a>
                  </Link>
                </li>
                {/* <li>
            ...
            >
              ...
              >
                <FormattedMessage id="sayfalar" values={{ name }} />
              </a>
              <i
                className={
                  state.activeMenu === "pages"
              ...
              >
                <li>
                  <Link href="/hotel-facilities">
                    <a><FormattedMessage id="tesislerimiz" values={{ name }} /></a>
                  </Link>
                </li>
               
                <li>
                  <Link href="/faq">
                    <a><FormattedMessage id="sss" values={{ name }} /></a>
                  </Link>
                </li>
              </ul>
            </li>
            ...
            <li onClick={() => dispatch({ type: "blog" })}>
              <Link href="/blog">
                <a  className="link-style">
                  <FormattedMessage id="blog" values={{ name }} />
                </a>
              </Link>
            </li>
            ...
            <li>
              <Link href="/contact">
                <a>
                  <FormattedMessage id="iletisim" values={{ name }} />
                </a>
              </Link>
            </li>
            ...
            <li className="menu-item-has-children">
              <a
                ...
                onClick={() => dispatch({type:"dil"})}
                className={
                  state.activeMenu === "dil" ? "active drop-down" : "drop-down"
                }
              >
                <i
                className={
                  state.activeMenu === "dil"
                    ? "bx bx-minus dropdown-icon"
                    : "bx bx-plus dropdown-icon"
                }
              />
                <i style={{opacity:0.9, marginRight:4,color:" #3CAA9F"}} className="fa-regular fa-font-awesome flag-icon bayrak"></i>
                {getButtonText()}
              </a>
        ...
        <div className="nav-right d-flex align-items-center">
          ...
          <div className="header-btn">
            <Link href="/contact">
              <a className="btn--primary eg-btn">
              <FormattedMessage
                        id="rezervasyon"
                        values={{ name }}
                      />
