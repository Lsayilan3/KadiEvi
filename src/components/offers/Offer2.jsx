...
function Offer2({name}) {
  ...
  return (
    <div className="home-two-offer mb-120">
      <div className="container-fluid">
        <div className="row mb-50">
          <div className="col-lg-12 d-flex justify-content-center">
            <div className="section-title2 text-center">
              <span><FormattedMessage id="enIyiTeklif" values={{ name }}/></span>
              <h2> <FormattedMessage id="suitHouse" values={{ name }}/></h2>
              <img src="assets/images/icons/section-bg.svg" alt="" />
            </div>
          </div>
        </div>
        <div className="row justify-content-center">
          <Swiper {...offerSlider} className="swiper-container offer-slider1">
            <div className="swiper-wrapper">
                  ...
                  <SwiperSlide  className="swiper-slide">
                    ...
                    <Link href="/room-suits1">
                      <div className="offer-img">
                        <img className="img-fluid" src="assets/images/bg/1116konsolevi.jpg" alt="" />
                      </div>
                      </Link>
                  ...
                  {/* <SwiperSlide  className="swiper-slide">
                    <div className="offer-wraper">
                      <div className="offer-img">
                        <img className="img-fluid" src="assets/images/bg/hayat11.jpg" alt="" />
                      </div>
                      <div className="content d-flex justify-content-between">
                        <div className="left-content">
                ...
                <SwiperSlide  className="swiper-slide">
                    <div className="offer-wraper">
                      ...
                      <div className="offer-img">
                        <img className="img-fluid" src="assets/images/bg/kadievi1111.JPG" alt="" />
                      </div>
                      </Link>
                  ...
                  <SwiperSlide  className="swiper-slide">
                    ...
                    <Link href="/room-suits3">
                      <div className="offer-img">
                        <img className="img-fluid" src="assets/images/bg/kuzeyoda1111.JPG" alt="" />
                      </div>
                      </Link>
                      <div className="content d-flex justify-content-between">
                        <div className="left-content">
        ...
        <div className="row align-items-center g-4 pt-30">
          <div className="col-md-6 d-flex justify-content-center order-sm-2 order-1">
            <div className="view-all-btn">
              <Link href="/room-suits1">
                <a className="btn--primary3"><FormattedMessage id="viewOurAllOfferRoom" values={{ name }}/></a>
              </Link>
            </div>
          </div>
          <div className="col-md-6 d-flex justify-content-center">
            <div className="swiper-btn d-flex align-items-center">
              <div className="btns swiper-button-prev-f" style={{cursor:"pointer"}}>
                <svg
                  width={26}
                  height={13}
                  viewBox="0 0 26 13"
              ...
              <div className="btns swiper-button-next-f">
                <svg
                  width={26}
                  height={14}
                  viewBox="0 0 26 14"
